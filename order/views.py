...
class PayCart(View):
    ...
    def post(self, request):
        try:
            ...
            if(payment=='cod'):
                donhang = DonHang.objects.create(KhachHang=khachhang, SoDienThoai=phone, DiaChi=address, GhiChu=note, TongTien=thanhtoan, TrangThai="cxl", PhuongThuc="cod")
                donhang.save()
            if(payment=='paypal'):
                donhang = DonHang.objects.create(KhachHang=khachhang, SoDienThoai=phone, DiaChi=address, GhiChu=note, TongTien=thanhtoan, TrangThai="dtt", PhuongThuc="ppl")
                donhang.save()
