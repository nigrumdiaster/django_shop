...
class CustomerOrderDetail(View):
    ...
    def get(self, request, id):
        try:
            ...
            data = {"title": "Thông Tin Đơn Hàng ĐH000" + str(id), "chitietdonhang": chitietdonhang, "madon": id, "phiship": phiship, "phivat": phivat, "thanhtoan": thanhtoan, "tongdon": total_price, "phuongthuc": phuongthuc}
            return render(request, self.template_name, data)
        except:
            return render(request, template_error)
